  ...
  return (
    ...
    >
      ...
      <div className="hero-reveal relative z-10 grid min-h-screen lg:grid-cols-[0.95fr_1.05fr]">
        <header className="relative flex items-start justify-start px-6 pt-24 pb-12 sm:px-10 sm:pt-28 sm:pb-12 lg:px-12 lg:pt-20 xl:pt-32 lg:pb-0 lg:pl-12 xl:pl-16">
