                  ...
                  {socialLinks.map((link, index) => {
                    ...
                    return isExternal ? (
                      <a
                        key={index}
                        href={link.href}
                        className={cn("flex items-center justify-center w-11 h-11 rounded-xl bg-white/[0.06] border border-white/15 text-white/85 hover:text-white hover:bg-white/[0.14] hover:border-white/35 transition-all duration-300 hover:scale-110 shadow-lg", link.className)}
                        target="_blank"
